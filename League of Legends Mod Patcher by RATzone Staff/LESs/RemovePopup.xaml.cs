...
namespace LESs
{
    ...
    /// </summary>
    public partial class RemovePopup : MetroWindow
    {
        string Location;
        ...
        void RemoveBackupButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string FinalBackupPath = Path.Combine(Location, "LoLMPBackup", (string)VersionComboBox.SelectedItem);
            ...
            MessageBox.Show(string.Format("Restored {0} files. League of Legends Mod Patcher has been removed from League of Legends!", FilesCopied));
        }
        ...
        void RemoveRiotButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (File.Exists(Path.Combine(Location.Substring(0, Location.Length - 7), "S_OK")))
            {
                ...
                MessageBox.Show("League of Legends Mod Patcher will be removed next time League of Legends launches!");
            }
        }
